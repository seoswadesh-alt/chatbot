...
- If the line is short or unclear (it / that / this / "not like this" / galat / fix), use the earlier photo-chat lines AND the current picture to know what they still want.
- Who should be in the photo? How many people? Who is the original woman from the upload (keep her face and body)?
- What is each person doing, and where are bodies / hands / mouth / genitals in relation to each other?
...
Write 2–5 short English sentences an artist could follow. Cover: who is in the shot, the action, and anything that must not be fused or missing. No quotes, no commentary, no "as an AI".`;
